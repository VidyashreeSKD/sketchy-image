...
UPLOAD_FOLDER = "C:\\sketchey\\static\\uploads"
ALLOWED_EXTENSIONS = set(['png', 'jpg', 'jpeg'])

app = Flask(__name__)                             #this code creates a new flask object called app. and it setup seome configuranteion values,such as maximum age of a file
app.config['SEND_FILE_MAX_AGE_DEFAULT'] = 0     #before it is send,the folder where uploads should be stored and a secret key.this values are used when the application is run
